# -*- coding: utf-8 -*-
"""
Created on Mon May  1 00:51:51 2023
...
from alg import pre_gen, algorithm


playid = '6UeSakyzhiEt4NB3UAd6NQ'
...
class GUI(tk.Tk):
    def __init__(self):
        ...
        self.notebook.add(self.screen1, text="Welcome")
        self.notebook.add(self.screen2, text="Selection")
        self.notebook.add(self.screen3, text="Results")
        ...
        button11 = tk.Button(self.screen1, text="Playlist 1", fg="white", bg="#0074D9", font=("Arial", 20), command=lambda: set_x('6UeSakyzhiEt4NB3UAd6NQ'))
        button11.pack(pady=10)
       
        button12 = tk.Button(self.screen1, text="Playlist 2", fg="white", bg="#0074D9", font=("Arial", 20), command=lambda: set_x('37i9dQZF1DX5Vy6DFOcx00'))
        button12.pack(pady=10)
       
        button13 = tk.Button(self.screen1, text="Playlist 3", fg="white", bg="#0074D9", font=("Arial", 20), command=lambda: set_x('37i9dQZF1EIgIwPJju1vhX'))
        ...
        def get_user_input():
           ...
           print(arraysongs)
           pre_gen(x, arraysongs)
           recommend_songs = algorithm()
           #print(recommend_songs)
           self.labelsong1 = tk.Label(self.screen3, text = f"{recommend_songs[0]['name']},\n{recommend_songs[1]['name']},\n{recommend_songs[2]['name']},\n{recommend_songs[3]['name']},\n{recommend_songs[4]['name']},\n{recommend_songs[5]['name']},\n{recommend_songs[6]['name']},\n{recommend_songs[7]['name']},\n{recommend_songs[8]['name']},\n{recommend_songs[9]['name']},\n{recommend_songs[10]['name']},\n{recommend_songs[11]['name']}")
           self.labelsong1.pack(padx=50, pady=(50, 0))
